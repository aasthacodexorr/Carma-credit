        ...
        <>
            ...
            <div className="w-full  mt-8">
                ...
                <div className="mt-5 flex items-center justify-center gap-2 text-gray-700 font-medium text-[14px]">
                    <div className="w-8 h-8 rounded-full border border-brand-green bg-white flex items-center justify-center shadow-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-brand-green" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
