...
export const metadata: Metadata = {
  title: "What Do I Need? | Carma Credit - Get Prepared. Get Approved.",
  description:
...
export default function WhatDoINeedPage() {
  const essentials = [
    ...
    },
    {
      ...
      subtitle: "",
      description: "A recent utility bill, bank statement or government document.",
      icon: (
    ...
    },
    {
      ...
      subtitle: "",
      description: "A void cheque or direct deposit form for payment setup.",
      icon: (
    ...
    },
    {
      ...
      subtitle: "",
      description:
        "Let us know the type of vehicle you're interested in (or we can help you find one).",
      icon: (
        /* Front Car View */
        <svg className="w-9 h-9" viewBox="0 0 32 32" fill="none" aria-hidden="true">
          <path
            d="M7 14L9.5 7.5C9.8 6.6 10.6 6 11.6 6H20.4C21.4 6 22.2 6.6 22.5 7.5L25 14C26.1 14.4 27 15.5 27 16.8V23C27 23.6 26.6 24 26 24H25V25.5C25 26.3 24.3 27 23.5 27H22C21.2 27 20.5 26.3 20.5 25.5V24H11.5V25.5C11.5 26.3 10.8 27 10 27H8.5C7.7 27 7 26.3 7 25.5V24H6C5.4 24 5 23.6 5 23V16.8C5 15.5 5.9 14.4 7 14Z"
            fill="#ff385c"
          />
          <path d="M10.2 9H21.8L23.2 13.5H8.8L10.2 9Z" fill="#fae2ef" />
          <circle cx="8.5" cy="18" r="1.5" fill="#fae2ef" />
          <circle cx="23.5" cy="18" r="1.5" fill="#fae2ef" />
          <rect x="12" y="17.5" width="8" height="2" rx="0.5" fill="#fae2ef" />
        </svg>
      ),
    },
    {
      ...
      description:
        "If you have a trade-in, down payment or special circumstances, we'll let you know if anything else is needed.",
      icon: (
          ...
          <div className="relative z-20 w-full max-w-[1480px] mx-auto px-6 sm:px-10 lg:pl-16 xl:pl-24 py-14 sm:py-16 lg:py-20">
            <div className="max-w-[500px] xl:max-w-[540px] flex flex-col items-start justify-center">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-[46px] xl:text-[50px] font-extrabold tracking-tight leading-[1.12] mb-5">
                <span className="text-white lg:text-[#131b4d] block">Get Prepared.</span>
                <span className="text-[#ff385c] block">Get Approved.</span>
              </h1>

              <p className="text-white lg:text-[#4b5563] text-base lg:text-lg leading-[1.65] mb-8">
              ...
              <div className="flex flex-col lg:flex-row  flex-wrap items-start lg:items-center gap-y-4 lg:gap-4 sm:gap-6 pt-2 text-white lg:text-[#131b4d]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex lg:flex-col gap-2 lg:gap-0 text-base sm:text-[18px] font-bold text-white lg:text-[#131b4d] leading-tight">
                    <span>Faster</span>
                    <span>approvals</span>
                  </div>
                </div>
