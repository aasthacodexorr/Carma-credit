          ...
          >
            ...
            >
              ...
              <div className="mt-14 pb-10 flex flex-col h-full gap-8 items-start">
                ...
                <Link href={"/book-an-appointment"} className="block text-center cursor-pointer text-white font-medium text-base w-full hover:opacity-90 transition-opacity rounded-full border-2 border-brand py-3 px-[30px] bg-brand-btn-gradient">
