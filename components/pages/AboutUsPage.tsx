  ...
  return (
    <>
      ...
      <main className="w-full overflow-hidden bg-white">
        ...
        {/* ========================================================================= */}
        {/* SECTION 1: HERO (Stacked clearly on mobile/tablet, intact on desktop) */}
        {/* ========================================================================= */}
        <section className="relative w-full overflow-hidden bg-[#fff7fb] lg:min-h-[540px] xl:min-h-[580px] flex flex-col lg:flex-row items-center">
          ...
          {/* DESKTOP BACKGROUND IMAGE (Hidden on mobile/tablet, absolute on desktop to keep original layout untouched) */}
          <div className="hidden lg:block absolute inset-y-0 right-0 w-[60%] xl:w-[58%] overflow-hidden pointer-events-none">
            <div
          ...
          <div className="relative z-20 w-full max-w-[1480px] mx-auto px-6 sm:px-10 lg:pl-16 xl:pl-24 py-10 sm:py-16 lg:py-20">
            <div className="max-w-full sm:max-w-[480px] xl:max-w-[610px] flex flex-col items-start justify-center">
              ...
              <p className="text-[#4b5563] text-base sm:text-lg lg:text-lg leading-[1.65] mb-8">
        ...
        {/* ========================================================================= */}
        <section className="relative w-full py-12 sm:py-20 lg:py-16 bg-white">
          <div className="w-full max-w-[1360px] mx-auto px-6 sm:px-6 lg:px-8">
            ...
            <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-14">
              ...
              <p className="text-[#4b5563] text-base sm:text-lg leading-[1.65] max-w-2xl mx-auto">
            ...
            {/* Clean 3-Column Values Card (2x2 grid on mobile like reference, desktop unchanged) */}
            <div className="w-full rounded-2xl sm:rounded-3xl bg-[#fdf5f9] border border-[#f8dfea] p-6 sm:p-8 lg:py-12 lg:px-8">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-y-8 gap-x-4 md:divide-y-0 md:divide-x divide-[#f2d2e1] md:gap-0">
                {/* Column 1: People First */}
                <div className="flex flex-col items-center text-center px-2 sm:px-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#fae2ef] flex items-center justify-center text-[#ff385c] mb-3 sm:mb-5 shrink-0">
                    <svg
                  ...
                  <h3 className="text-sm sm:text-xl font-bold text-[#131b4d] mb-1 sm:mb-2">
                    People First
                  </h3>
                  <p className="text-[#4b5563] text-xs sm:text-base leading-[1.4] sm:leading-[1.6] max-w-[240px]">
                    We treat every customer with respect, honesty and care.
                  </p>
                </div>

                {/* Column 2: Real Solutions */}
                <div className="flex flex-col items-center text-center px-2 sm:px-6 pt-0 md:pt-0">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#fae2ef] flex items-center justify-center text-[#ff385c] mb-3 sm:mb-5 shrink-0">
                    <svg
                      className="w-6 h-6 sm:w-8 sm:h-8"
                      fill="currentColor"
                  ...
                  <p className="text-[#4b5563] text-xs sm:text-base leading-[1.4] sm:leading-[1.6] max-w-[250px]">
                    We work with trusted automotive lending partners to find options that fit your situation.
                  </p>
                </div>

                {/* Column 3: Brighter Tomorrows */}
                <div className="col-span-2 md:col-span-1 flex flex-col items-center text-center px-2 sm:px-6 pt-4 md:pt-0 border-t md:border-t-0 border-[#f2d2e1] md:border-l">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#fae2ef] flex items-center justify-center text-[#ff385c] mb-3 sm:mb-5 shrink-0">
                    <svg
                      className="w-6 h-6 sm:w-8 sm:h-8"
                      fill="currentColor"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-6 order-2 lg:order-1">
                <div className="relative mx-auto w-full aspect-[4/3] rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl bg-slate-100 border border-slate-100">
                  ...
                  <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-8 text-left max-w-xs pointer-events-none drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                    <p className="font-script text-white text-2xl sm:text-4xl font-semibold leading-tight tracking-wide transform rotate-[-3deg]">
                      Real People.
                    </p>
                    <p className="font-script text-white text-2xl sm:text-4xl font-semibold leading-tight tracking-wide transform rotate-[-3deg]">
                      Real Second Chances.
              ...
              <div className="lg:col-span-6 order-1 lg:order-2 flex flex-col items-start space-y-2">
                <span className="text-sm sm:text-[13px] font-bold tracking-[0.2em] text-brand uppercase">
                  Why We Do It
                </span>
                ...
                <div className="space-y-5 text-[#4b5563] text-base sm:text-lg lg:text-xl leading-[1.65]">
                  <p>
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto px-5 sm:px-8 text-center flex flex-col items-center">
            <span className="text-sm sm:text-[13px] font-bold tracking-[0.2em] text-brand uppercase mb-1">
            ...
            <p className="text-[#4b5563] text-base sm:text-lg leading-[1.65] max-w-2xl mb-8">
