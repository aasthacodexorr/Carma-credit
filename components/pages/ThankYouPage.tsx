    ...
    <>
      ...
      <main className="w-full bg-white overflow-hidden text-[#102a5c]">
        ...
        <section className="relative w-full bg-white pt-2 sm:pt-3 lg:pt-4 pb-0">
          ...
          {/* Kept unchanged from your existing desktop design */}
          ...
          <div className="relative z-10 w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="md:hidden relative w-[calc(100%+2rem)] -ml-4 px-4 pt-16 pb-20 mb-8 overflow-hidden rounded-2xl">
              ...
              <div className="relative z-10 max-w-[620px] flex flex-col items-start pt-1 sm:pt-2">
                ...
                <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-[1.08] mb-4 sm:mb-5">
                  <span className="text-[#102a5c]">You’re </span>
                  <span className="text-[#ff385c]">All Set!</span>
                </h1>

                <p className="text-[#102a5c] text-[17px] sm:text-[19px] leading-[1.42] font-normal mb-6 max-w-[540px]">
            ...
            {/* ================= TOP HERO TEXT (Desktop Only) ================= */}
            <div className="hidden md:flex relative z-10 max-w-[620px] lg:max-w-[660px] flex-col items-start pt-8 sm:pt-24">
              <span className="text-[14px] sm:text-[15px] font-bold tracking-[0.18em] text-brand uppercase">
                THANK YOU
              </span>
