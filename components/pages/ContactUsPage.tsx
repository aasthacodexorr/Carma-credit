...
export default function ContactUs() {
  ...
  useEffect(() => {
    const handleMessage = (event: MessageEvent) => {
      // Only accept messages from the Carma iframe
  ...
  return (
    <PageShell>
      <div className="dw-font bg-white px-4 py-10 text-[#121212] sm:px-6 lg:mt-4 lg:px-10 lg:py-14 xl:px-24">
        <div className="mx-auto grid w-full max-w-[1350px] grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          {/* =========================
              CONTACT FORM
          ========================= */}
          <div className="w-full min-w-0 rounded-2xl bg-white shadow-[0_16px_50px_rgba(18,18,18,0.14)] ring-1 ring-black/5">
            <iframe
              ref={iframeRef}
              id="contact_form"
              name="iframe_a"
              ...
              title="Contact Us"
              scrolling="no"
              className="block w-full max-w-full border-0 rounded-2xl"
              style={{
                width: "100%",
                height: `${height}px`,
