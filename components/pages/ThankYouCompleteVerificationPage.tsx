        ...
        <section className="py-20 pb-8 text-gray-900 bg-background-light">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-20 gap-4 sm:gap-12 md:gap-24 w-full px-4">
              ...
              <Link href={"/about-us"} className="whitespace-nowrap cursor-pointer text-white text-base py-3 px-6 rounded-full border-2 border-brand transition duration-200 shadow-sm hover:opacity-90 bg-brand">
                Call Dealership
              </Link>
        ...
        <section className="bg-white max-w-[1250px] mx-auto px-4 pt-12 md:pt-20">
          <div className="grid gap-8 md:grid-cols-2 items-start">
            ...
            <div className="max-w-xl md:mt-10">
              ...
              <Link className="w-fit text-white text-base py-5 px-10 cursor-pointer rounded-full border-2 border-brand transition duration-200 hover:opacity-90 bg-brand" href={"/contact-us"}>
                Get started
              </Link>
            </div>
